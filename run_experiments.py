...
class ExperimentLogger(Node):
    ...
    def status_callback(self, msg):
        # Currently only SUCCESS is enabled
...
def run_benchmarking():
    ...
    # Path to your CSV file with starting poses, can be randomly generated by the diff_drive_robot/scripts/generate_starting_poses.py script
